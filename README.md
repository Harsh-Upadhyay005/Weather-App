...
The **Weather App** is a responsive, user-friendly web application designed to display real-time weather information based on the city entered by the user. 
It provides detailed and accurate weather insights using the OpenWeather API, including temperature, humidity, wind speed, AQI (Air Quality Index), 
sunrise & sunset timing, and a 3-day forecast. The app also features a dynamic background that changes according to the weather conditions.
...
The Weather App is a fast, feature-rich, and visually appealing application aimed at providing accurate weather insights with a modern UI/UX. Its dynamic features such AQI visualization, and a responsive 3‑day forecast.
